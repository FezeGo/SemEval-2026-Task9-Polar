...
from src.subtask3.dataset import load_all_languages_data
from src.subtask3.constants import LABEL_COLUMNS, NUM_LABELS


# =========================
# Paths
# =========================
TEST_DIR = "data/test_phase/subtask3/test"
SUBMISSION_DIR = "outputs/subtask3/ensemble_submission"

XLM_R_MODEL_PATH = "checkpoints/subtask3/xlmr_final_model"
MDEBERTA_MODEL_PATH = "checkpoints/subtask3/mdeberta_final_model"
